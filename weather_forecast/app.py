...
# Image
new = ImageTk.PhotoImage(Image.open('images/logo.png'))
...
if int((dt.strftime('%I'))) >= 8 & int((dt.strftime('%I'))) <= 5:
	...
	img = ImageTk.PhotoImage(Image.open('images/un.png'))
	panel = Label(root, image=img)
	panel.place(x=210, y=200)
...
def city_name():
	...
	api_request = requests.get("https://api.openweathermap.org/data/2.5/weather?q="
							+ city_entry.get() + "&units=metric&appid="+ {c46e4ebb2ecba00893691e992f5e7239})
